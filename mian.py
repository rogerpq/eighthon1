...
async def _(event):
    ...
    isclaim.clear()
    isclaim.append("off")
    await sedthon.send_message(event.chat_id, "**- تم الانتهاء من التثبيت بنجاح**")


@sedthon.ar_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@sedthon.ar_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
